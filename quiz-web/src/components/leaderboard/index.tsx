  ...
  return (
    <>
      <Spin spinning={isLeaderboardLoading} size="large">
        <div style={containerStyle} id="leaderboard-container" className=" min-w-96">
          <Row>
                      ...
                      <div
                        ...
                        className={`px-4 flex items-center py-2 gap-6 ${
                          user?.username === item?.username
                            ? item?.usedticket
                              ? 'rounded-3xl text-[#662FBF] bg-[#00FFE0]'
                              : 'rounded-3xl text-[#662FBF] bg-white'
                            : item?.usedticket
                            ? 'text-[#00FFE0]'
                            : 'text-white'
                        }`}
          ...
          >
            <div className="pt-4 pb-8 w-full shadow-xl text-black  rounded-3xl">
