...
class CustomerApi {
  async getCustomers(options) {
    ...
    const sortedCustomers = applySort(filteredCustomers, sort, sort_by);
  ...
  async getCustomerOrders(options = {}) {
    ...
    // axiosClient('/payment/:_id', { _id: customerId })
    //   .then((result) => {
    //     console.log(result);
    //   })
    //   .catch(err => {
    ...
    const sortedOrders = applySort(customerOrders, sort, sort_by);
