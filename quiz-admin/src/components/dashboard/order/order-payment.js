...
xs={12}>
          <PropertyList>
            <PropertyListItem label="Stripe Payment ID"
value={order?.paymentId} />
            <PropertyListItem label="Payment Status"
value={paymentStatusOption.label} />
            <PropertyListItem label="Payment Method"
...
xs={12}>
          <PropertyList>
            <PropertyListItem label="Courier"
value={order.courier} />
            <PropertyListItem label="Tracking ID"
