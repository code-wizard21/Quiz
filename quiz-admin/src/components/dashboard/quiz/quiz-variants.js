...
import { ProductVariantDialog } from "./quiz-variant-dialog";
...
variant="body2">
                  ...
                  <TableCell>{format(variant.createdAt, "MMM dd yyyy")}</TableCell>
...
sx={{ mx: 2 }} />
        ...
        {displayUnavailable && (
          <ResourceUnavailable onCreate={handleOpenVariantDialog}
sx={{ m: 2 }} />
        )}
      </Card>
